...
```{r M1, eval=F, results='asis', tidy=FALSE}
...
##### QUIZ:
我們可以算出對「所有族群」的『選定對向』實施這項工具的期望報酬 ...
```{r}
Target = CX
Target$ExpReturn = (effect - Target$ProbRetain) * Target$PredRevenue - cost
...
根據以上的計算：<br>
&emsp; ■ 實施這一項工具效率最高的族群是？<br>
&emsp; ■ 這個結論是合理的嗎？<br> 
&emsp; ■ 我們應該如何改進這個行銷企劃，讓他變得更合理呢？<br><br>
</p class="qiz"><br>

<p class="wwl">
<span style="font-size:24px">`r "\U1F4A1"` 學習重點：</span><br>
**1.如果你只有顧客ID、交易日期、交易金額三個欄位的話，你可以做的分析包括：**<br>
&emsp; ■ 顧客分群、標籤<br>
&emsp; ■ 全體顧客和每一個顧客分群的：<br>
&emsp; &emsp; &emsp; □ 族群大小與成長趨勢<br>
&emsp; &emsp; &emsp; □ 族群屬性分析：如平均CLV、平均營收貢獻、成長率、毛利率等等<br>
&emsp; &emsp; &emsp; □ 組間流量和流動機率<br>
&emsp; ■ 每一個顧客的：<br>
&emsp; &emsp; &emsp; □ 保留率、預期購買金額、終身價值<br>
&emsp; &emsp; &emsp; □ 目前所在群組，以及下一期會轉到個群組的機率<br>
&emsp; &emsp; &emsp; □ 組間流量和流動機率<br><br>
**2.如果我們有有行銷工具的使用紀錄的話，我們也可以估計：**<br>
&emsp; ■ 每一樣行銷工具、對每一位顧客的成功機率<br><br>
**3.一般而言，這一些分析的結果，足夠讓我們制定「顧客發展」和「顧客保留」策略；**<br><br>
**4.至於「顧客吸收」策略，我們通常還需要從CRM撈出顧客個人屬性資料才能做到。**<br><br>
</p class="wwl"><br>
